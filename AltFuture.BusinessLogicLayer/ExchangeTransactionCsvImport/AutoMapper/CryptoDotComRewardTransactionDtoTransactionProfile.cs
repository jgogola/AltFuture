...
{
    public class CryptoDotComRewardTransactionDtoTransactionProfile : Profile
    {
        public CryptoDotComRewardTransactionDtoTransactionProfile()
        {

            DateTime createdDate = DateTime.Now;

            CreateMap<CryptoDotComRewardTransactionDto, Transaction>()
