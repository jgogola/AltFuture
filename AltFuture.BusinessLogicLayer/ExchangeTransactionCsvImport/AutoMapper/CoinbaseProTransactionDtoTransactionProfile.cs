...
{
    public class CoinbaseProTransactionDtoTransactionProfile : Profile
    {
        public CoinbaseProTransactionDtoTransactionProfile()
        {
            DateTime createdDate = DateTime.Now;

            CreateMap<CoinbaseProTransactionDto, Transaction>()
